    ...
    return (
        <div className="_feed_inner_timeline_post_area _b_radious6 _padd_b24 _padd_t24 _mar_b16">
            ...
            <div className="_timline_comment_main">
                {
                    commentsCount > 2 && <div className="_previous_comment">
                        <button type="button" className="_previous_comment_txt">View {commentsCount - 2} more comments</button>
                    </div>
                }
                {
                    comments?.data?.map((comment: IComment) => <CommentCard key={comment?._id} comment={comment} />)
                }
            </div>
        </div>
    );
