                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
                        <li className="nav-item _header_nav_item">
                            <Link className="nav-link _header_nav_link_active _header_nav_link" aria-current="page" href="feed.html">
                        ...
                        <li className="nav-item _header_nav_item">
                            <Link className="nav-link _header_nav_link" aria-current="page" href="friend-request.html">
                                        ...
                                        <div className="_notifications_all">
                                            <div className="_notification_box">
                                                <div className="_notification_image">
                                                    <Image height={1000} width={1000} src="/images/friend-req.png" alt="Image" className="_notify_img" />
                                                </div>
                                            ...
                                            <div className="_notification_box">
                                                <div className="_notification_image">
                                                    <Image height={1000} width={1000} src="/images/profile-1.png" alt="Image" className="_notify_img" />
                                                </div>
                                                <div className="_notification_txt">
                                                    <p className="_notification_para">
                        ...
                        <li className="nav-item _header_nav_item">
                            <Link className="nav-link _header_nav_link" aria-current="page" href="chat.html">
