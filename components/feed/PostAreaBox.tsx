    ...
    const [state, formAction, isPending] = useActionState<State, FormData>(
        async (_prev, formData) => {
            try {
                ...
                postFormData.append('content', formData.get('content') as string);
                postFormData.append('visibility', formData.get('visibility') as string);
                if (formData.get('image')) {
                    postFormData.append('image', formData.get('image') as File);
                }
                ...
                return { error: e instanceof Error ? e.message : 'Failed to create post', success: false };
            }
        },
        initialState
    );
    ...
    return (
        <div className="_feed_inner_text_area _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
            <form onSubmit={handleSubmit}>
                ...
                {imagePreview && (
                    <div className="_feed_inner_text_area_image_preview" style={{ margin: '10px 0', position: 'relative', display: 'inline-block' }}>
                        <Image
                            src={imagePreview}
                            alt="Preview"
                            width={200}
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', margin: '12px 0' }}>
                    <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }}>
                        <span style={{ fontSize: '14px', color: '#666' }}>Visibility:</span>
                        <div
                            ...
                            style={{
                                ...
                                width: '44px',
                                height: '24px',
                                backgroundColor: isPublic ? '#1877f2' : '#ccc',
                                borderRadius: '12px',
                                cursor: 'pointer',
