                        ...
                        <ul className="_left_inner_area_explore_list">
                            ...
                            <li className="_left_inner_area_explore_item _explore_item">
                                <Link href="#0" className="_left_inner_area_explore_link">
                                    ...
                                    </svg>Gaming</Link> <span className="_left_inner_area_explore_link_txt">New</span>
                            </li>
                            <li className="_left_inner_area_explore_item">
                                <Link href="#0" className="_left_inner_area_explore_link">
                    ...
                    <div className="_left_inner_area_suggest _padd_t24  _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
                            ...
                            <div className="_left_inner_area_suggest_info_box">
                                <div className="_left_inner_area_suggest_info_image">
                                    <Link href="profile.html">
                                        <Image height={1000} width={1000} src="/images/people1.png" alt="Image" className="_info_img" />
                                    </Link>
                                </div>
                        ...
                        <div className="_left_inner_area_suggest_info">
                            <div className="_left_inner_area_suggest_info_box">
                                <div className="_left_inner_area_suggest_info_image">
                                    <Link href="profile.html">
                                        <Image height={1000} width={1000} src="/images/people2.png" alt="Image" className="_info_img1" />
                                    </Link>
                                </div>
                                <div className="_left_inner_area_suggest_info_txt">
                                    <Link href="profile.html">
                        ...
                        <div className="_left_inner_area_suggest_info">
                            <div className="_left_inner_area_suggest_info_box">
                                <div className="_left_inner_area_suggest_info_image">
                                    <Link href="profile.html">
                                        <Image height={1000} width={1000} src="/images/people3.png" alt="Image" className="_info_img1" />
                                    </Link>
                                </div>
                                <div className="_left_inner_area_suggest_info_txt">
                                    <Link href="profile.html">
                        ...
                        <Link className="_left_inner_event_card_link" href="event-single.html">
                            <div className="_left_inner_event_card">
                                <div className="_left_inner_event_card_iamge">
                                    <Image height={1000} width={1000} src="/images/feed_event1.png" alt="Image" className="_card_img" />
                                </div>
