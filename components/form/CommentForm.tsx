...
import { IComment } from '../card/CommentCard';
    ...
    const mutation = useMutation({
        ...
        onMutate: async ({ text: commentText }) => {
            ...
            const optimisticComment: IComment = {
                _id: `temp-${Date.now()}`,
                text: commentText,
                author: author || { firstName: '', lastName: '', avatar: avatar || '' },
                likeCount: 0,
                replyCount: 0,
        ...
        <form className="_feed_inner_comment_box_form" onSubmit={handleSubmit}>
            <div className="_feed_inner_comment_box_content">
                <div className="_feed_inner_comment_box_content_image">
                    <Image height={1000} width={1000} src={avatar || ''} alt="" className="_comment_img" />
                </div>
            ...
            <div className="_feed_inner_comment_box_icon">
                {
                    text ?
                        <button type="submit" className="_feed_inner_comment_box_icon_btn" disabled={mutation.isPending}>
                            Send
                        </button>
                        :
                        <>
                            <button type="submit" className="_feed_inner_comment_box_icon_btn" disabled={mutation.isPending || !text.trim()}>
